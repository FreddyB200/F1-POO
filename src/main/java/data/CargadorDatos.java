...
public class CargadorDatos {
    ...
    public static List<Circuito> cargarCircuitos() {
        return List.of(
                new Circuito(1, "Bahrain International Circuit", "Bahrein", "Sakhir", 5412.0, 57, parse("2024-03-02"), null),
                new Circuito(2, "Jeddah Corniche Circuit", "Arabia Saudita", "Yeda", 6174.0, 50, parse("2024-03-09"), null),
                new Circuito(3, "Albert Park Circuit", "Australia", "Melbourne", 5278.0, 58, parse("2024-03-24"), null),
                new Circuito(4, "Suzuka International Racing Course", "Japón", "Suzuka", 5807.0, 53, parse("2024-04-07"), null),
                new Circuito(5, "Shanghai International Circuit", "China", "Shanghái", 5451.0, 56, parse("2024-04-21"), parse("2024-04-20")),
                new Circuito(6, "Miami International Autodrome", "Estados Unidos", "Miami", 5412.0, 57, parse("2024-05-05"), parse("2024-05-04")),
                new Circuito(7, "Autodromo Internazionale Enzo e Dino Ferrari", "Italia", "Imola", 4909.0, 63, parse("2024-05-19"), null), // Emilia Romagna
                new Circuito(8, "Circuit de Monaco", "Mónaco", "Monte Carlo", 3337.0, 78, parse("2024-05-26"), null),
                new Circuito(9, "Circuit Gilles Villeneuve", "Canadá", "Montreal", 4361.0, 70, parse("2024-06-09"), null),
                new Circuito(10, "Circuit de Barcelona-Catalunya", "España", "Montmeló", 4657.0, 66, parse("2024-06-23"), null),
                new Circuito(11, "Red Bull Ring", "Austria", "Spielberg", 4318.0, 71, parse("2024-06-30"), parse("2024-06-29")),
                new Circuito(12, "Silverstone Circuit", "Reino Unido", "Silverstone", 5891.0, 52, parse("2024-07-07"), null),
                new Circuito(13, "Hungaroring", "Hungría", "Budapest", 4381.0, 70, parse("2024-07-21"), null),
                new Circuito(14, "Circuit de Spa-Francorchamps", "Bélgica", "Stavelot", 7004.0, 44, parse("2024-07-28"), null),
                new Circuito(15, "Circuit Zandvoort", "Países Bajos", "Zandvoort", 4259.0, 72, parse("2024-08-25"), null),
                new Circuito(16, "Autodromo Nazionale Monza", "Italia", "Monza", 5793.0, 53, parse("2024-09-01"), null), // Italia
                new Circuito(17, "Baku City Circuit", "Azerbaiyán", "Bakú", 6003.0, 51, parse("2024-09-15"), null),
                new Circuito(18, "Marina Bay Street Circuit", "Singapur", "Singapur", 5063.0, 62, parse("2024-09-22"), null),
                new Circuito(19, "Circuit of the Americas", "Estados Unidos", "Austin", 5513.0, 56, parse("2024-10-20"), parse("2024-10-19")), // USA
                new Circuito(20, "Autódromo Hermanos Rodríguez", "México", "Ciudad de México", 4304.0, 71, parse("2024-10-27"), null),
                new Circuito(21, "Autódromo José Carlos Pace", "Brasil", "São Paulo", 4309.0, 71, parse("2024-11-03"), parse("2024-11-02")), // São Paulo
                new Circuito(22, "Las Vegas Strip Circuit", "Estados Unidos", "Las Vegas", 6201.0, 50, parse("2024-11-23"), null), // Las Vegas
                new Circuito(23, "Lusail International Circuit", "Qatar", "Lusail", 5419.0, 57, parse("2024-12-01"), parse("2024-11-30")),
                new Circuito(24, "Yas Marina Circuit", "Emiratos Árabes Unidos", "Abu Dhabi", 5281.0, 58, parse("2024-12-08"), null) // Abu Dhabi
        );
    }
    ...
    public static List<Piloto> cargarPilotos(List<Equipo> equipos) {
        ...
        List<Piloto> pilotosList = List.of(
                ...
                new Piloto(24, "Liam Lawson", 0, 4.0, equiposPorNombre.get("Visa Cash App RB F1 Team"), 40, "LAW", 6, 0, 0, 0, 0, Map.of(), "Neozelandés", 23, new TemporadaActual(21, 6, 0, "Abu Dhabi GP", parse("2024-12-08")))
        );
